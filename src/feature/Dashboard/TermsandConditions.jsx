...
// Sample structured data extracted from the image
const sections = [
    {
        id: 'acceptance',
        title: 'Acceptance',
...
export default function TermsAndConditions() {
    ...
    return (
            ...
            <div className=" justify-center flex flex-row gap-[36px]">
                ...
                <div className="max-w-[370px] w-full h-[573px] flex flex-col p-5 bg-white rounded-[16px] shadow-sm border border-gray-100">
